...
nohup ros2 launch motion motion.launch.py ns:=robot4 joy:=0 > /dev/null 2>&1 &
nohup ros2 launch motion motion.launch.py ns:=robot5 joy:=1 > /dev/null 2>&1 &
nohup ros2 launch motion motion.launch.py ns:=robot6 joy:=2 > /dev/null 2>&1 &
